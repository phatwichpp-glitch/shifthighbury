        ...
        <div className="bg-white rounded-[24px] shadow-[0_20px_60px_rgba(0,0,0,0.12)] p-10 max-w-sm w-full">
          ...
          {!studentId ? (
            <div className="text-center">
              ...
              <p className="text-gray-500 text-[14px]">ลิงก์ไม่ถูกต้อง กรุณาติดต่อ{TEACHER_ROLE_LABEL}ครับ</p>
            </div>
          ) : (
            <div className="text-center">
              ...
              {studentName && <p className="text-gray-500 text-[14px] mb-1">สวัสดีครับคุณ <strong>{studentName}</strong></p>}
              ...
              <p className="text-gray-400 text-[12px] mb-4 flex items-center justify-center gap-1"><AlertTriangle className="w-3.5 h-3.5 text-amber-400 flex-shrink-0" />ส่งตัวอักษรทั้งหมดนี้มาให้ครบนะครับ อย่าแก้ไขครับ</p>
              ...
              <p className="text-gray-400 text-[12px] mt-4">หลังส่งรหัสแล้ว ระบบจะตอบกลับยืนยันทาง LINE ครับ</p>
            </div>
          )}
        </div>
      </div>
